...
const PRIZE_LIST = [
  ...
  { name: "Makeup Kit by PureU", packs: 6, emoji: "💄" },
  { name: "Surprise Box by Youaretheprincess", packs: 2, emoji: "🎁" },
  { name: "Haircare Set by MonchoMoreno", packs: 3, emoji: "💇‍♀️" },
  { name: "Surprise Box by Niche Beauty Lab", packs: 3, emoji: "✨" },
  { name: "Hair & Body Set", packs: 6, emoji: "🚿" },
  { name: "Spa Day by Nobu (2pax)", packs: 1, emoji: "💆‍♂️" },
  { name: "Chocolate Lover by Lindt", packs: 6, emoji: "🍫" },
  { name: "Gourmet Experience by Pepina Pastel", packs: 3, emoji: "🍰" },
  { name: "Wearable Box by DCU", packs: 1, emoji: "⌚" },
  { name: "Long Dream Hair Set by Olistic", packs: 1, emoji: "🌿" },
